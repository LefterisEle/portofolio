            ...
            <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
                ...
                <div className='shadow-lg shadow-[#040c16] group container rounded-md
                    ...
                    <div className='opacity-0 group-hover:opacity-100'>
                        <p className='text-2xl font-bold text-white tracking-wider'>
                            Mock Ecommerce with React
                        </p>
                    
                        <div className='pt-8 text-center' >
                            <a href='https://mock-ecommerce-with-react.netlify.app/' target="_blank">
                                <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>Demo</button>
                            </a>
                            <a href='https://github.com/LefterisEle/Mock-Ecommerce-with-React' target="_blank">
                ...
                <div className='shadow-lg shadow-[#040c16] group container rounded-md
                    ...
                    <div className='opacity-0 group-hover:opacity-100'>
                        ...
                        <div className='pt-8 text-center' >
                            <a href='https://project-movie-searcher.netlify.app/' target="_blank">
                                <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>Demo</button>
                            </a>
                            <a href='https://github.com/LefterisEle/Movie-Search-with-React' target="_blank">
                                <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>Code</button>
                            </a>
                        </div>
                    </div>
